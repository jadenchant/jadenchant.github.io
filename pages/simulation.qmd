...
We can determine from the simulated samples that there is a large difference from the total mean price of Airbnbs in the Chicago area, specifically on Central and Southwest Chicago. There are no 
