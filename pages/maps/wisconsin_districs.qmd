...
extract_dir <- file.path(tempdir(), "districts_data")

download.file(src, dest_zip)

unzip(dest_zip, exdir = extract_dir)

dsn_districts <- file.path(extract_dir, "districtShapes")

districts <- st_read(dsn = dsn_districts, layer = "districts113") |>
