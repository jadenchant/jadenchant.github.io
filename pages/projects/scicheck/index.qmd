---
title: "FactCheck.org SciCheck Articles"
...
[Link to FactCheck.org SciCheck Articles](https://www.factcheck.org/scicheck/)

[Link to FactCheck.org SciCheck Articles Data](https://www.kaggle.com/datasets/jadenc4/factchecks-scicheck-article-dataset)
...
scicheck |> write_csv("./data/factcheck_scicheck.csv")
```
...
scicheck <- read_csv("./data/factcheck_scicheck.csv")
...
combined_scicheck <- scicheck |> bind_rows(new_scicheck)

combined_scicheck |> arrange(date) |> write_csv("./data/factcheck_scicheck.csv")
```
