...
![ConfMat](confmat.png){width=700}

![SensitivitySpecificity](sens_spec.png){width=700}
...
This final review is significantly more difficult and does not correctly identify the negative sentiment. 
