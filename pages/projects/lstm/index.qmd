...
The ROC Curve in the lower right corner of the graph which means that our model is extremely good at predicting the inverse of what the sentiment should be.
...
![ConfMat](confmat.pdf){width=700}

![SensitivitySpecificity](sens_spec.pdf){width=700}
...
Correctly classified positive sentiment
	(pred = 0.887)


Correctly classified negative sentiment
	(pred = 0.28)


Misclassified negative sentiment
	(pred = 0.75)
